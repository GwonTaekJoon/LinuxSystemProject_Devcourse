...
public:
    ...
    /// @param[in]  memory - pointer a block of static memory for allocator or NULL
    ...
    /// Get a pointer a memory block.
    /// @param[in]  size - size of the block a allocate
    ...
    /// @returns    The number of fixed memory blocks created.
...
private:
    ...
    /// @return    Returns pointer to the block. Otherwise NULL if unsucessful.
    void *Pop();
