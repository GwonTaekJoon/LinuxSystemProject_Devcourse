...
Allocator::~Allocator()
{
    // If using pool then destory it, otherwise traverse free-list and
...
void *Allocator::Allocate(size_t size)
{
    ...
    //If can't obtain existing block the get a new one
    void *pBlock = Pop();
    if(!pBlock) {


        // If using a pool method the get block from pool,
